var DemoApp = DemoApp || {}; DemoApp["redux"] =
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Unsafe_Coerce = __webpack_require__(3);
	var Control_Monad_Eff = __webpack_require__(5);
	var Control_Monad_Eff_Console = __webpack_require__(7);
	var Control_Monad_Eff_Ractive = __webpack_require__(9);
	var Control_Monad_Eff_Redux = __webpack_require__(22);
	var simpleLogger = function (store) {
	    return function (next) {
	        return function (action) {
	            return function __do() {
	                Control_Monad_Eff_Console.log("Middleware (Logger) :: Action: " + (action.type + (", payload: " + action.payload)))();
	                return next(action)();
	            };
	        };
	    };
	};
	var onIncrementClicked = function (r) {
	    return function (e) {
	        return function __do() {
	            var v = Control_Monad_Eff_Ractive.get("store")(r)();
	            var v1 = Control_Monad_Eff_Redux.dispatch({
	                type: "INCREMENT", 
	                payload: "TEST INCR"
	            })(v)();
	            return Prelude.unit;
	...
	var onDecrementClicked = function (r) {
	    return function (e) {
	        return function __do() {
	            var v = Control_Monad_Eff_Ractive.get("store")(r)();
	            var v1 = Control_Monad_Eff_Redux.dispatch({
	...
	var numericListener = function (store) {
	    return function __do() {
	        var v = Control_Monad_Eff_Redux.getState(store)();
	        return Control_Monad_Eff_Console.log("STATE: " + Unsafe_Coerce.unsafeCoerce(v))();
	    };
	};
	...
	var main = (function () {
	    var middlewares = [ simpleLogger ];
	    return function __do() {
	        var v = Control_Monad_Eff_Redux.applyMiddleware(middlewares)(counter)(1)();
	        return (function () {
	            ...
	            return function __do() {
	                var v1 = Control_Monad_Eff_Ractive.ractive(appSettings)();
	                Control_Monad_Eff_Redux.subscribe(numericListener(v))(v)();
	                Control_Monad_Eff_Ractive.on("increment-clicked")(onIncrementClicked(v1))(v1)();
	                Control_Monad_Eff_Ractive.on("decrement-clicked")(onDecrementClicked(v1))(v1)();
	                return Control_Monad_Eff_Console.log("Demo App with Redux!")();
	            };
	        })()();
	    };
	})();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Prelude = __webpack_require__(1);
	var Control_Monad_Eff = __webpack_require__(5);
	var Data_Maybe = __webpack_require__(12);
	var Data_Foreign_EasyFFI = __webpack_require__(20);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var Prelude = __webpack_require__(1);
	var Control_Alt = __webpack_require__(13);
	var Control_Alternative = __webpack_require__(14);
	var Control_Extend = __webpack_require__(16);
	var Control_MonadPlus = __webpack_require__(17);
	var Control_Plus = __webpack_require__(15);
	var Data_Functor_Invariant = __webpack_require__(18);
	var Data_Monoid = __webpack_require__(19);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ffiP: ffiP, 
	    ffiF: ffiF, 
	    applyMiddleware: $foreign.applyMiddleware, 
	    replaceReducer: $foreign.replaceReducer, 
	    getState: $foreign.getState, 
	    dispatch: $foreign.dispatch, 
	    subscribe: $foreign.subscribe, 
	    createStore: $foreign.createStore
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Control_Monad_Eff_Console = __webpack_require__(7); //ugly! Maybe better via WebPack?
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsBindActionCreators = __webpack_require__(31);
	
	var _utilsBindActionCreators2 = _interopRequireDefault(_utilsBindActionCreators);
	
	var _utilsApplyMiddleware = __webpack_require__(32);
	
	var _utilsApplyMiddleware2 = _interopRequireDefault(_utilsApplyMiddleware);
	
	var _utilsCompose = __webpack_require__(33);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsIsPlainObject = __webpack_require__(26);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mapValues = __webpack_require__(29);
